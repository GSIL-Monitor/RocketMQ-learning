 ...
 *
 * 一个cluster下有多个broker name, 一个broker name下仅有一个master 但是可以有多个slaver
 *
 * 该类用于维护 master 和 slaver的对于关系的
 */
public class BrokerData implements Comparable<BrokerData> {
    private String cluster;
    private String brokerName;
    /**
     * 缓存每个broker ID与地址的对应关系, slaver在注册时，name server会将master的地址返回过去
     */
